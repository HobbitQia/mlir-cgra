...
#define DEBUG_TYPE "nonlinear-to-cgra"
...
string NonlinearPatternToCGRAConverter::getMatchedPattern(std::vector<string> &arithOptNames, string pattern) {
...
LogicalResult mlir::convertNonlinearPatternToCGRALaunch(Operation *op) {
